...
{   
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => "https://api.yelp.com/v3/businesses/search?term=$term&location=$location&radius=10",
...
function doDate($username, $search, $cuisine, $diet, $restrictions, $type, $calories, $location, $mile)
{
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/searchComplex?query=$search&cuisine=$cuisine&excludeIngredients=soy&type=$type&minCalories=0&maxCalories=$calories&limitLicense=false&offset=0&number=100",
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => "",
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 30,
