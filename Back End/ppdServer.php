...
function requestProcessor($request)
{
  ...
  switch ($request['type'])
  {
   ...
   //Register********************************************************************************************
    ...
    case "Date":
      echo "\n*Type: Date\n";
      $response_msg = doDate($request['username'],$request['search'],$request['cuisine'],$request['diet'],$request['restrictions'],$request['foodType'],$request['calories'],$request['location'],$request['mile'],$request['date']);
      break;
    //Validate********************************************************************************************
...
echo "Database ppdRabbitMQServer BEGIN".PHP_EOL;
$server->process_requests('requestProcessor');
echo "Database ppdRabbitMQServer END".PHP_EOL;
exit();
?>
